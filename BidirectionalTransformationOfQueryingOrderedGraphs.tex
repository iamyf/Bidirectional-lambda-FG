...
$\mbox{~~~~}\mathbf{let}\,G_1\Cao^p G_2=(V_1\cup V_2\cup V',B',I')$\\
...
$\mbox{~~~~~~}B'=B_1\cup B_2\cup\{Code\,p\,\&m\mapsto[\mathbf{Edge}(\epsilon,I_1(\&m)),\mathbf{Edge}(\epsilon,I_2(\&m))]\mid \&m\in M\}$\\
